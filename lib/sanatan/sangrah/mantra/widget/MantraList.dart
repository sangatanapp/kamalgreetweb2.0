...
Widget mantraListWidget(bool isMobile) {
  if (mantraCtrl.mantraList.isEmpty) {
    return Center(
      child: Card(
  ...
  return ListView.separated(
    ...
    shrinkWrap: true,
    itemCount: mantraCtrl.mantraList.length,
              ...
              child: Container(
                ...
                child: ClipRRect(
                  borderRadius: const BorderRadius.only(
                      ...
                      bottomLeft: Radius.circular(20)),
                  child: Image.network(
                    mantraCtrl.mantraList[index].audioLink ?? "",
                    fit: BoxFit.fill,
                        ...
                        child: Column(
                          ...
                          children: [
                            Flexible(
                              flex: 1,
                              child: Text(
                                  mantraCtrl.mantraList[index].title ?? "",
                            ...
                            Flexible(
                              flex: 1,
                              child: Text(
                                  mantraCtrl.mantraList[index].description ??
                                      "",
                                  overflow: TextOverflow.ellipsis,
                                  style: GoogleFonts.poppins(
                                      fontSize: isMobile ? 12 : 18,
                            ...
                            Flexible(
                                flex: 1,
                                child: mantraCtrl.richTextMaker(
                                    isMobile: isMobile,
                                    iconName: Icons.accessibility_rounded,
                                    titlePrefix: 'God Id',
                                    title: mantraCtrl.mantraList[index].godId
                                        .toString())),
                          ],
                        ),
                      ),
