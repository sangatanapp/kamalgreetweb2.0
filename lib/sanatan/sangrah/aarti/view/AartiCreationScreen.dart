...
import 'package:kamal_greet_web_2/sanatan/sangrah/aarti/viewmodel/AartiViewModel.dart';
import 'package:kamal_greet_web_2/sanatan/widgets/SanatanGodSelector.dart';

import '../../../../Utils/values/AppConstants.dart';

final AartiViewModel aartiCtrl = Get.put(AartiViewModel());

class AartiCreationScreen extends StatefulWidget {
  const AartiCreationScreen({super.key});

  @override
  State<AartiCreationScreen> createState() => _AartiCreationScreenState();
}

class _AartiCreationScreenState extends State<AartiCreationScreen> {
  @override
            ...
            child: Column(
              ...
              children: [
                ...
                creationSubTitle(
                    ...
                    DynamicTextfield(
                      onChange: (value) {
                        aartiCtrl.aartiTitleTextCtrl.refresh();
                      },
                      maxLength: AppConstants.maxtitleLength,
                      controller: aartiCtrl.aartiTitleTextCtrl.value,
                      height: 55,
                ...
                creationSubTitle(
                    ...
                    DynamicTextfield(
                      onChange: (value) {
                        aartiCtrl.aartiDescTextCtrl.refresh();
                      },
                      minLines: 5,
                      controller: aartiCtrl.aartiDescTextCtrl.value,
                      height: 55,
                      fillColor: AppColors.whiteCard,
                ...
                Row(
                  ...
                  children: [
                    ...
                    DynamicButton(
                        ...
                        onTap: () {
                          if (aartiCtrl.aartiTitleTextCtrl.value.text.isEmpty) {
                            EasyLoading.showError("Enter title");
                            return;
                          } else if (aartiCtrl
                              .aartiDescTextCtrl.value.text.isEmpty) {
                            EasyLoading.showError("Enter Description");
                            return;
                          } else {
                            aartiCtrl.createAarti();
                          }
                        })
                  ],
                ),
