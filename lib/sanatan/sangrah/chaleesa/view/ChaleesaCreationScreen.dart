...
import 'package:kamal_greet_web_2/sanatan/sangrah/chaleesa/viewmodel/ChaleesaViewModel.dart';
import 'package:kamal_greet_web_2/sanatan/widgets/SanatanGodSelector.dart';

import '../../../../Utils/values/AppConstants.dart';

final ChaleesaViewModel chaleesaCtrl = Get.put(ChaleesaViewModel());

class ChaleesaCreationScreen extends StatefulWidget {
  const ChaleesaCreationScreen({super.key});

  @override
  State<ChaleesaCreationScreen> createState() => _ChaleesaCreationScreenState();
}

class _ChaleesaCreationScreenState extends State<ChaleesaCreationScreen> {
  @override
            ...
            child: Column(
              ...
              children: [
                ...
                creationSubTitle(
                    ...
                    DynamicTextfield(
                      onChange: (value) {
                        chaleesaCtrl.chaleesaTitleTextCtrl.refresh();
                      },
                      maxLength: AppConstants.maxtitleLength,
                      controller: chaleesaCtrl.chaleesaTitleTextCtrl.value,
                      height: 55,
                ...
                creationSubTitle(
                    ...
                    DynamicTextfield(
                      onChange: (value) {
                        chaleesaCtrl.chaleesaDescTextCtrl.refresh();
                      },
                      minLines: 5,
                      controller: chaleesaCtrl.chaleesaDescTextCtrl.value,
                      height: 55,
                      fillColor: AppColors.whiteCard,
                ...
                Row(
                  ...
                  children: [
                    ...
                    DynamicButton(
                        ...
                        onTap: () {
                          if (chaleesaCtrl
                              .chaleesaTitleTextCtrl.value.text.isEmpty) {
                            EasyLoading.showError("Enter title");
                            return;
                          } else if (chaleesaCtrl
                              .chaleesaDescTextCtrl.value.text.isEmpty) {
                            EasyLoading.showError("Enter Description");
                            return;
                          } else {
                            chaleesaCtrl.createChaleesa();
                          }
                        })
                  ],
                ),
