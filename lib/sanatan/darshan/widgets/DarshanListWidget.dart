...
Widget darshanListWidget(bool isMobile) {
  if (darshanCtrl.darshanList.isEmpty) {
    return Center(
      child: Card(
  ...
  return ListView.separated(
    ...
    shrinkWrap: true,
    itemCount: darshanCtrl.darshanList.length,
              ...
              child: Container(
                ...
                child: ClipRRect(
                  borderRadius: const BorderRadius.only(
                      ...
                      bottomLeft: Radius.circular(20)),
                  child: Image.network(
                    darshanCtrl.darshanList[index].godUrl ?? "",
                    fit: BoxFit.fill,
                          ...
                          children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  Flexible(
                                    flex: 5,
                                    child: Text(
                                      darshanCtrl.darshanList[index].title ??
                                          "",
                              ...
                              child: Row(
                                ...
                                children: [
                                  Flexible(
                                    flex: 5,
                                    child: Text(
                                      darshanCtrl.darshanList[index].description ??
                                          "",
                                      overflow: TextOverflow.ellipsis,
                                      style: GoogleFonts.poppins(
                                        fontSize: isMobile ? 12 : 18,
                            ...
                            Flexible(
                              ...
                              child: richTextMaker(
                                  ...
                                  title: DateFormat('dd MMM yyyy, hh:mm a')
                                      .format(DateTime.parse(darshanCtrl
                                              .darshanList[index].createdAt ??
                                          ""))),
                            ),
                            ...
                            Flexible(
                              ...
                              child: richTextMaker(
                                  ...
                                  titlePrefix: 'God Id',
                                  title: darshanCtrl.darshanList[index].godId
                                      .toString()),
                            ),
                            IconButton(
                                onPressed: () {
