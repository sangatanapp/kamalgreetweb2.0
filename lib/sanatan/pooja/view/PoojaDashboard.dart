                                                    ...
                                                    child: IconButton(
                                                        onPressed: () {
                                                          Clipboard.setData(
                                                                  ClipboardData(
                                                                      text:
                                                                          "https://sanatan-dharma-app.web.app/#/pooja/${poojaDashboardCtrl.poojaData[index].id ?? 0}"))
                                                              .then(
                                                            (value) => Fluttertoast
                                                                .showToast(
                                                                    msg:
                          ...
                          children: [
                                        ...
                                        Flexible(
                                          ...
                                          child: RadioListTile(
                                              ...
                                              onChanged: (value) {
                                                ...
                                                poojaDashboardCtrl.mrpController
                                                    .clear();
                                                poojaDashboardCtrl
                                                    .singlePaymentController
                                                    .clear();
                                                poojaDashboardCtrl
                                                    .singlePaymentDisplayController
                                                    .clear();
                                                poojaDashboardCtrl
                                                    .discountTagController
                                                    .clear();
                                              },
                                                ...
                                                DynamicTextfield(
                                                    ...
                                                    onChange: (value) {
                                                      poojaDashboardCtrl
                                                              .singlePaymentDisplayController
                                                              .text =
                                                          "₹${poojaDashboardCtrl.singlePaymentController.text} मात्र";
                                                    },
                                                    fillColor:
                                                        AppColors.whiteCard,
                                                    hintText: "Pooja amount")),
                                          ),
                                          Flexible(
                                            flex: 1,
                                            child: creationSubTitle(
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                ElevatedButton(
                                  onPressed: () {
                                    if (poojaDashboardCtrl.validateFields()) {
