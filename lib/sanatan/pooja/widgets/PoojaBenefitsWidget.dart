...
Widget poojaBenefitsWidget(
  ...
  return Column(
    children: [
      ...
      Visibility(
        visible: (poojaDetailsCtrl.poojaDetailsData.length == 0 ||
            poojaDetailsCtrl.poojaDetailsData.isEmpty),
        child: Padding(
                                ...
                                onPressed: () {
                                  if (poojaDetailsCtrl
                                    ...
                                    poojaDetailsCtrl.updatePoojaDetails(
                                        whichTab: "benefits", poojaId: poojaId);
                                  }
                                },
                                style: ElevatedButton.styleFrom(
                                  backgroundColor:
