  ...
  Future createGuruPost() async {
    ...
    final res = await api.createGuruPost(
        "Bearer ${GreetStorage.getAuthToken()!}",
        {
          ...
          // "start_time": postKaroCreationCtrl.startTimeString.value,
          // "end_date": postKaroCreationCtrl.endDateString.value,
          // "end_time": postKaroCreationCtrl.endTimeString.value,
          "tag_list": [],
          "category_list": [],
          // "wishes_position": postKaroCreationCtrl.selectedWishesPosition.value,
          ...
          "avatar_shape": "square",
          "post_type": "image",
          // "post_url": postKaroCreationCtrl.mainPostImage.value,
